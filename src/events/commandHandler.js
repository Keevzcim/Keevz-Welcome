...
module.exports = async (msg) => {
  ...
  const embed = new MessageEmbed().setColor(client.Renks[Math.floor(Math.random() * client.Renks.length)]).setAuthor(msg.member.displayName, msg.author.avatarURL({ dynamic: true, size: 2048 }));
  args = args.splice(1);
